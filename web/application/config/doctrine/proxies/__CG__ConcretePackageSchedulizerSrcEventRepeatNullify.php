 ...
 */
class EventRepeatNullify extends \Concrete\Package\Schedulizer\Src\EventRepeatNullify implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'eventID', 'hideOnDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventRepeatNullify $proxy) {
