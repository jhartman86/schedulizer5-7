 ...
 */
class EventRepeat extends \Concrete\Package\Schedulizer\Src\EventRepeat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'eventID', 'repeatWeek', 'repeatDay', 'repeatWeekday');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventRepeat $proxy) {
